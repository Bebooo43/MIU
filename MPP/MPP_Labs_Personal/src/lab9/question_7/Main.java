...
public class Main {
	...
	public static void ordering1(List<Integer> list) {
		System.out.println(list.stream().sorted((int1, int2) -> Math.abs(int1) == Math.abs(int2) ? Integer.compare(int1,int2) : Integer.compare(Math.abs(int1),Math.abs(int2))).collect(Collectors.toList()));	
		
		//Teacher solution
		//System.out.println(list.stream().sorted(Comparator.comparing((Integer x) -> (int)Math.abs(x)).thenComparing(Integer x)).collect(Collectors.toList()));	
	}
	...
	public static void ordering2(List<String> words) {
		System.out.println(words.stream().sorted((str1, str2) -> new StringBuilder(str1).reverse().compareTo(new StringBuilder(str2).reverse())).collect(Collectors.toList()));		
		words.stream()
		.sorted((str1, str2) -> new StringBuilder(str1).reverse().compareTo(new StringBuilder(str2).reverse()))
